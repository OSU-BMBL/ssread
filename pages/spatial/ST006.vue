              ...
              <v-card-text>
                <p class="my-2">
                  ...
                  <span class="text--primary font-weight-medium"
                    ...
                    resolution with Slide-seqV2</span
                  >
                </p>
                <p class="my-2">
                  <span class="text--secondary">Authors: </span>
                  <span class="text--primary"
                    >Robert R Stickels, Evan Murray, Pawan Kumar, Jilong Li,
                    Jamie L Marshall, Daniela J Di Bella, Paola Arlotta, Evan Z
                    Macosko, Fei Chen <sup>$</sup></span
                  >
                </p>
                <p class="my-2">
                  <span class="text--secondary">Date published: </span>
                  <span class="text--primary">12-07-2020</span>
                </p>
                <p class="my-2">
            ...
            <v-col cols="12" class="py-0 my-0">
              ...
              <v-card-text>
                ...
                <p class="my-2">
                  ...
                  <span class="text--primary">cortex and striatum</span>
                </p>
                <p class="my-2">
                ...
                <v-row>
                  <v-col cols="8">
                    ...
                    <span class="text--primary"
                      ><v-img
                        src="https://media.springernature.com/lw685/springer-static/image/art%3A10.1038%2Fs41587-020-0739-1/MediaObjects/41587_2020_739_Fig1_HTML.png?as=webp"
                        target="_blank"
                        class="text-decoration-none"
                        max-width="800px"
                      >

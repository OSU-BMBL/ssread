              ...
              <v-card-text>
                ...
                <p class="my-2">
                  ...
                  <span class="text--primary"
                    >Sanja Vickovic, Gökcen Eraslan, Fredrik Salmén, Johanna
                    Klughammer, Linnea Stenbeck, Denis Schapiro, Tarmo Äijö,
                    Richard Bonneau, Ludvig Bergenstråhle, José Fernandéz
                    Navarro, Joshua Gould, Gabriel K Griffin, Åke Borg, Mostafa
                    Ronaghi, Jonas Frisén, Joakim Lundeberg, Aviv Regev, Patrik
                    L Ståhl<sup>$</sup></span
                  >
                </p>
                <p class="my-2">
                  <span class="text--secondary">Date published: </span>
                  <span class="text--primary">9-9-2019</span>
                </p>
                <p class="my-2">
                ...
                <p class="my-2">
                  ...
                  <span class="text--primary"
                    ><a
                      href="https://www.nature.com/articles/s41592-019-0548-y"
                      target="_blank"
                ...
                <p class="my-2">
                  ...
                  <span class="text--primary"
                    ><a
                      href="https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE130682"
                      target="_blank"
                      class="text-decoration-none"
                    >
                      Download data
              ...
              <v-card-text>
                ...
                <v-row>
                  <v-col cols="12">
                    ...
                    <span class="text--primary"
                      ><v-img
                        src="https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fs41592-019-0548-y/MediaObjects/41592_2019_548_Fig1_HTML.png?as=webp"
                        target="_blank"
                        class="text-decoration-none"
                        max-width="800px"
                      >

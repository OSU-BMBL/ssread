            ...
            <v-col cols="12" class="py-0 my-0">
              ...
              <v-card-text>
                ...
                <p class="my-2">
                  ...
                  <span class="text--primary"
                    ><a
                      href="https://www.sciencedirect.com/science/article/pii/S0092867420308151"
                      target="_blank"
              ...
              <v-card-text>
                ...
                <v-row>
                  <v-col cols="6">
                    ...
                    <span class="text--primary"
                      ><v-img
                        src="https://ars.els-cdn.com/content/image/1-s2.0-S2589004220307483-fx1_lrg.jpg"
                        target="_blank"
                        class="text-decoration-none"
                        max-width="800px"
                      >
